...
public class Homepage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mGifsRef = new Firebase("https://signapp-aab9e.firebaseio.com/gifffs");
        ...
        Toast.makeText(this, "root is " + mRef.getApp(), Toast.LENGTH_SHORT).show();


        //Firebase Child = mGifsRef.child("Nawww");
        //Child.setValue("Henrywwww");
        ...
        for(int i=0; i<values.length; i++){
            mRef = new Firebase("https://signapp-aab9e.firebaseio.com/categories/"+values[i][0]);
           // mRefChild = mRef.child();
           // mRefChild.setValue("Henry");
    ...
    public void firebase(View v){
        ...
        Toast.makeText(this, "Setting value", Toast.LENGTH_SHORT).show();
